...
CREATE TABLE `lessons` (
	...
	`start_code` varchar(1500) DEFAULT NULL,
	PRIMARY KEY (`id`),
...
INSERT INTO `level_entities` VALUES (3,7,6,9,'Bessie',0),(4,1,11,3,'Cow',0);
...
INSERT INTO `levels` VALUES (1,'Hello, World!',-1,-1,-1,0,0,15,7,3,3,'Welcome to the game!\r\nBelow.. bla bla bla bla helpful text here.','Help for the level'),(2,'Movement',1,-1,-1,10,0,0,0,0,0,'',''),(3,'Obstacles',2,-1,-1,20,10,0,0,0,0,'',''),(4,'Attacks',1,-1,-1,-10,0,0,0,0,0,'',''),(6,'Mazes',3,-1,-1,20,20,0,0,0,0,'',''),(7,'Enemies',4,-1,-1,-20,-10,10,10,4,4,'','');
...
INSERT INTO `user_levels` VALUES (2,1,1,NULL),(7,1,2,NULL);
...
INSERT INTO `users` VALUES (1,'root','admin',2,2,1),(2,'nixon','TESTRichard',0,0,1),(3,'admin','admin',0,0,0);
...
-- Dump completed on 2017-11-16 16:18:31
